...
from chemfish.namers.compound_namers import TieredCompoundNamer
...
class Lookups(LookupTool):
    ...
    def runs(
        ...
        # ('when_cmd_run', '', lambda r: ValarRuns.fetch_tag_optional(r, 'datetime_command_entered')),
        # ('sauronx_vr', '', lambda r: ValarRuns.fetch_tag_optional(r, 'sauronx_version')),
    ...
    def transfer_plates(
        ...
        *wheres: Union[ExpressionsLike, int, str, TransferPlates],
        ...
        return Lookups._simple(
            ...
            "id",
            "name",
            ("description", "description", Tools.truncate60),
            ("plate_type", "plate_type.name"),
            ("parent", "parent.name"),
            ("supplier", "supplier.name"),
            ("creator", "creator.username"),
